...
<form action="gravar.php" method="POST">				
		<div class="container pt-5">
			<div class="card bg-light">
					<div class="card-body">
					<h4 class="display-4 text-center ">Comprar Livros</h4>
					...
					<div class="form-group row justify-content-center">
						<label for="quantidade2" class=" col-form-label">Entrada</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputTitulo" name="entrada">
							</div>
					</div>
					<div class="class text-center">
						<button class="btn btn-secondary mb-2">Comprar</button>
					</div>
				</div>
			</div>
		</div>
